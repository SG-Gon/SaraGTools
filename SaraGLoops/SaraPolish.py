...
# Step 1: Ask user for input and output directory paths
...
# Step 3: Loop through all .fasta files in the input directory
for file_name in os.listdir(input_dir):
    if file_name.endswith(".fasta"):
        # Define paths for the fasta file, overlap file, and polished file
        fasta_path = os.path.join(input_dir, file_name)
        sample_suffix = os.path.basename(file_name).split(".fasta")[0]
        ...
        # Step 4: Run minimap2 to generate overlaps
        try:
            ...
            print(f"Error running minimap2 for {sample_suffix}")
            print(ascii_art_error)
            sys.exit(1)

        # Step 5: Run racon to polish based on overlaps
        try:
            ...
            print(f"Error running racon for {sample_suffix}")
            print(ascii_art_error)
            sys.exit(1)
